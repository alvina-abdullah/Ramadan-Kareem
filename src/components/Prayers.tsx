...
const Prayers: React.FC = () => {
  ...
  return (
    <div id='Prayers' className="min-h-screen bg-gradient-to-b  from-emerald-800 to-[#134725]">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl md:text-4xl py-7 text-white text-center font-bold mb-8">
