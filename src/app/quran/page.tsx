                ...
                {filteredSurahs.map((surah, index) => (
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      <span className="text-emerald-400 font-bold text-lg group-hover:text-emerald-300">{surah.number}</span>
                      <span className="text-emerald-100 text-sm px-3 py-1 rounded-full bg-emerald-900/60 border border-emerald-700/50">
                        {surah.revelationType}
                      </span>
                    </div>
                    <h3 className="text-xl font-semibold text-white mb-2 group-hover:text-emerald-200">{surah.englishName}</h3>
              ...
              <div className="col-span-full">
                ...
                <div className="space-y-6">
                  {ayahs.map((ayah, index) => (
                    ...
                    >
                      <p className="text-right text-3xl leading-loose text-white mb-6 font-arabic group-hover:text-emerald-100">{ayah.text}</p>
                      <p className="text-emerald-100/90 leading-relaxed">{ayah.translation}</p>
                    </motion.div>
                  ))}
                </div>
              </div>
